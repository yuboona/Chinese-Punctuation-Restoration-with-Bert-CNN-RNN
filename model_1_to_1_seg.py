...
class SegBertChineseLSTMLinearPunc(nn.Module):
    def __init__(self, segment_size, output_size, dropout, vocab_size):
        super(SegBertChineseLSTMLinearPunc, self).__init__()
        print("fucking code**************")
        self.bert = AutoModel.from_pretrained('./models/bert_base_chinese/')
        # self.bert_vocab_size = vocab_size
        # self.bn = nn.BatchNorm1d(segment_size*self.bert_vocab_size)
...
class SegRobertaChineseLSTMLinearPunc(nn.Module):
    def __init__(self, segment_size, output_size, dropout, vocab_size):
        super(SegRobertaChineseLSTMLinearPunc, self).__init__()
        print("fucking code**************")
        self.bert = BertModel.from_pretrained('./models/chinese-roberta-wwm-ext')
        # self.bert_vocab_size = vocab_size
        # self.bn = nn.BatchNorm1d(segment_size*self.bert_vocab_size)
...
class SegBertChineseLinearPunc(nn.Module):
    def __init__(self, segment_size, output_size, dropout, vocab_size):
        super(SegBertChineseLinearPunc, self).__init__()
        print("fucking code**************")
        self.bert = BertModel.from_pretrained('./models/bert_base_chinese/')
        # self.bert_vocab_size = vocab_size
        # self.bn = nn.BatchNorm1d(segment_size*self.bert_vocab_size)
...
class SegBertChineseSlimCNNBert(nn.Module):
    def __init__(self, segment_size, output_size, dropout, vocab_size):
        super(SegBertChineseSlimCNNBert, self).__init__()
        print("fucking code**************")
        self.bert = BertModel.from_pretrained('./models/bert_base_chinese/')
        # self.bert_vocab_size = vocab_size
        # self.bn = nn.BatchNorm1d(segment_size*self.bert_vocab_size)
        ...
        self.lstm = nn.LSTM(self.bert_size, self.bert_size, num_layers=3, batch_first=True, bidirectional=True)
        # NOTE dense*2 使用bert中间层 dense hidden_state self.bert_size
        self.dropout = nn.Dropout(dropout)
        # lstm_hidden *2
