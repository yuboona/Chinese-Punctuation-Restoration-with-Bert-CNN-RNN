...
from model_1_to_1 import (
    ...
    BertChineseRNNnoBnLinearPunc,
    ChineseRobertaRNNnewLinearPunc,
    ChineseRobertaCNNbnLstmPunc,
    ChineseRobertaCNNLstmPunc,
    ChineseRobertaNoCNNLstmPunc,
    ChineseRobertaNmlCNNLstmPunc,
    ChineseRobertaCNNlinearDivideConcatPunc,
    BertChineseCNNlinearDivideConcatPunc,
    ChineseRobertaCNNlinearDividedPunc,
    ChineseRobertaCNNlinearDividedBertPunc,
    BertChineseCNNlinearDividedBertPunc,
    BertChinese2BertPunc,
    BertChineseLSTMLinearPunc,
    BertChineseCNNreplace,
    BertChineseCNNreplaceBert,
    BertChineseSlimCNNBert,
    BertChinese4lyrHiddenCNN,
    BertChinese4lyrHiddenLinear,
    BertChineseBigStrideCNN,
    BertChineseSegHiddenLinearPunc,
    ...
    RobertaChineseEmbSlimCNNlstmBert,
    # seg模型
    RobertaLstmChineseSegBertLinearPunc,
    RobertaLstmChineseSegBertLstmLinearPunc,
)
...
def validate(model, criterion, epoch, epochs, iteration, iterations, data_loader_valid, save_path, train_loss, best_val_loss, best_model_path, punctuation_enc, best_f1_sum):
    ...
    for e in range(epochs):
        ...
        for inputs, labels in data_loader_train:
            ...
            if counter % print_every == 0:
                ...
                pbar.close()
                model.eval()
                best_val_loss, best_model_path, best_f1_sum = validate(model, criterion, e, epochs, iteration, iterations, data_loader_valid, 
                    save_path, train_loss, best_val_loss, best_model_path, punctuation_enc, best_f1_sum)
                model.train()
                pbar = tqdm(total=print_every)
                iteration += 1
...
if __name__ == '__main__':
    ...
    # # NOTE ChineseRobertaRNNnewLinearPunc
    # if CUDA:
    #     bert_punc = ChineseRobertaRNNnewLinearPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = ChineseRobertaRNNnewLinearPunc(seq_len, output_size, dropout, None)
    # # NOTE ChineseRobertaRNNnewLinearPunc
    # if CUDA:
    #     bert_punc = ChineseRobertaCNNLstmPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = ChineseRobertaCNNLstmPunc(seq_len, output_size, dropout, None)
    # # NOTE ChineseRobertaCNNlinearDivideConcatPunc
    # if CUDA:
    #     bert_punc = ChineseRobertaCNNlinearDivideConcatPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = ChineseRobertaCNNlinearDivideConcatPunc(seq_len, output_size, dropout, None)
    # # NOTE ChineseRobertaCNNlinearDividePunc
    # if CUDA:
    #     bert_punc = ChineseRobertaCNNlinearDividedPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = ChineseRobertaCNNlinearDividedPunc(seq_len, output_size, dropout, None)
    # # NOTE ChineseRobertaCNNlinearDivideBertPunc 两个bert分开 cnn+lstm
    # if CUDA:
    #     bert_punc = ChineseRobertaCNNlinearDividedBertPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = ChineseRobertaCNNlinearDividedBertPunc(seq_len, output_size, dropout, None)
    # # NOTE ChineseRobertaNoCNNLinearPunc
    # if CUDA:
    #     bert_punc = ChineseRobertaNoCNNLstmPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = ChineseRobertaNoCNNLstmPunc(seq_len, output_size, dropout, None)
    # # NOTE ChineseRobertaNnlCNN2lyr_lstmLinearPunc
    # if CUDA:
    #     bert_punc = ChineseRobertaNmlCNNLstmPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = ChineseRobertaNmlCNNLstmPunc(seq_len, output_size, dropout, None)
    ...
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChineseRNNnoBnLinearPunc(seq_len, output_size, dropout, None)
    # # NOTE BertChineseCNNlinearDivideConcatPunc
    # NOTE bert的embedding分叉，一个直接连linear，一个接cnn+lstm
    # if CUDA:
    #     bert_punc = BertChineseCNNlinearDivideConcatPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChineseCNNlinearDivideConcatPunc(seq_len, output_size, dropout, None)
    # # TODO bertCNNlinearDivideBertPunc 两个bert分开, cnn+lstm
    # if CUDA:
    #     bert_punc = BertChineseCNNlinearDividedBertPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChineseCNNlinearDividedBertPunc(seq_len, output_size, dropout, None)
    # # NOTE bertCNNlinearDivideBertPunc 两个bert分开, cnn+lstm
    # if CUDA:
    #     bert_punc = BertChinese2BertPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChinese2BertPunc(seq_len, output_size, dropout, None)
    # # NOTE Bert-Chinese-Linear
    # if CUDA:
    #     bert_punc = BertChineseLSTMLinearPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChineseLSTMLinearPunc(seq_len, output_size, dropout, None)
    # # NOTE BertChineseCNNreplace ,用CNN在bert emb层之后
    # if CUDA:
    #     bert_punc = BertChineseCNNreplace(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChineseCNNreplace(seq_len, output_size, dropout, None)
    # # NOTE BertChineseCNNreplaceBert ,用CNN在bert emb层之后 ; 再加另一个bert
    # if CUDA:
    #     bert_punc = BertChineseCNNreplaceBert(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChineseCNNreplaceBert(seq_len, output_size, dropout, None)
    # # TODO # NOTE BertChineseSlimCNNBert ,用CNN在bert emb层之后 ; 再加另一个bert
    # if CUDA:
    #     bert_punc = BertChineseSlimCNNBert(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChineseSlimCNNBert(seq_len, output_size, dropout, None)
    # # NOTE BertChinese4lyrHiddenCNN ,用CNN在bert emb层之后 ; 再加另一个bert
    # if CUDA:
    #     bert_punc = BertChinese4lyrHiddenCNN(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChinese4lyrHiddenCNN(seq_len, output_size, dropout, None)
    # # NOTE BertChinese4lyrHiddenLinear ,用CNN在bert emb层之后 ; 再加另一个bert
    # if CUDA:
    #     bert_punc = BertChinese4lyrHiddenLinear(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChinese4lyrHiddenLinear(seq_len, output_size, dropout, None)
    # # NOTE BertChineseBigStrideCNN ,用CNN在bert emb层之后 ; 再加另一个bert
    # if CUDA:
    #     bert_punc = BertChineseBigStrideCNN(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChineseBigStrideCNN(seq_len, output_size, dropout, None)
    # # NOTE BertChineseBigStrideCNN 使用分词模型，+bert
    # if CUDA:
    #     bert_punc = BertChineseSegHiddenLinearPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChineseSegHiddenLinearPunc(seq_len, output_size, dropout, None)
    # # NOTE BertChineseSlimCNNBertLSTM ,
    # 
    # if CUDA:
    #     bert_punc = BertChineseSlimCNNBertLSTM(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChineseSlimCNNBertLSTM(seq_len, output_size, dropout, None)
    # # NOTE BertChineseEmbSlimCNNBert ,
    # 
    # if CUDA:
    #     bert_punc = BertChineseEmbSlimCNNBert(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    ...
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = BertChineseEmbSlimCNNlstmBertLSTM(seq_len, output_size, dropout, None)
    # # NOTE RobertaChineseLinearPunc
    # if CUDA:
    #     bert_punc = RobertaChineseLinearPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = RobertaChineseLinearPunc(seq_len, output_size, dropout, None)
    # # NOTE RobertaChineseEmbSlimCNNlstmBert
    # if CUDA:
    #     bert_punc = RobertaChineseEmbSlimCNNlstmBert(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = RobertaChineseEmbSlimCNNlstmBert(seq_len, output_size, dropout, None)
    # # NOTE RobertaLstmChineseSegBertLinearPunc
    # if CUDA:
    #     bert_punc = RobertaLstmChineseSegBertLinearPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = RobertaLstmChineseSegBertLinearPunc(seq_len, output_size, dropout, None)
    # # # NOTE RobertaLstmChineseSegBertLstmLinearPun
    # if CUDA:
    #     bert_punc = RobertaLstmChineseSegBertLstmLinearPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = RobertaLstmChineseSegBertLstmLinearPunc(seq_len, output_size, dropout, None)
    ...
    #         {'params': bert_punc.encoder.conv.parameters(), 'lr': 10e-3},
    #         {'params': bert_punc.encoder.lstm.parameters(), 'lr': 10e-3},
    #         {'params': bert_punc.fc.parameters(), 'lr': learning_rate_all},
    #     ]
    #     )
    ...
    # # 为seg模型***不训练*****
    # for p in bert_punc.bert_seg.parameters():
    #     p.requires_grad = False
