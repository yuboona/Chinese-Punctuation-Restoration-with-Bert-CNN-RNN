...
if __name__ == '__main__':
    ...
    # 中文数据集 3punc**************************
    data_train = load_file('data/zh_seg/train_res')
    data_valid = load_file('data/zh_seg/test_res')
    data_test = load_file('data/zh_seg/test_res')
    # # IWSLT中文数据集**************************
    ...
    # # NOTE SegBertChineseLinearPunc
    # if CUDA:
    #     bert_punc = SegBertChineseLinearPunc(seq_len, output_size, dropout, None).cuda()
    # else:
    #     print("FUCKINHG********code")
    #     bert_punc = SegBertChineseLinearPunc(seq_len, output_size, dropout, None)

    # print(bert_punc)
    # # NOTE SegRobertaChineseLSTMLinearPunc
    if CUDA:
        bert_punc = SegRobertaChineseLSTMLinearPunc(seq_len, output_size, dropout, None).cuda()
    else:
        print("FUCKINHG********code")
        bert_punc = SegRobertaChineseLSTMLinearPunc(seq_len, output_size, dropout, None)
